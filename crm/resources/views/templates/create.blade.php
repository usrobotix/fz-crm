                ...
                <div class="bg-surface rounded-md shadow-dc-card p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <select name="status"
                            ...
                            <option value="deprecated" {{ old('status') === 'deprecated' ? 'selected' : '' }}>Устаревший</option>
                        </select>
                    </div>
                    <div>
                    ...
                    <div class="pt-2 flex gap-3">
                        ...
                        <a href="{{ route('templates.index') }}" class="px-5 py-2 text-dc-secondary hover:text-dc text-ys-s dc-transition">Отмена</a>
                    </div>
                </div>
